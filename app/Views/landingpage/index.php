...
<head>
    <meta charset="utf-8">
    <title>Absensi Online SMAN 4 Sukabumi</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <!-- Favicon -->
    <link href="assets/landingpage/img/logosmanpat.png" rel="icon">
    ...
    <link href="assets/landingpage/lib/animate/animate.min.css" rel="stylesheet">
...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
                <a href="index.html" class="navbar-brand d-lg-none">
                    <h1 class="text-primary m-0">SMAN<span class="text-dark">4</span></h1>
                </a>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="assets/landingpage/img/smanpat.jpg" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="assets/landingpage/img/smanpat3.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
    ...
    <script src="assets/landingpage/lib/wow/wow.min.js"></script>
    <script src="assets/landingpage/lib/easing/easing.min.js"></script>
    <script src="assets/landingpage/lib/waypoints/waypoints.min.js"></script>
    <script src="assets/landingpage/lib/counterup/counterup.min.js"></script>
